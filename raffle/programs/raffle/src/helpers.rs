...
pub fn transfer_tokens_with_seeds<'info>(
    ...
    .map_err(|_| error!(RaffleError::TokenTransferFailed))
}
...
pub fn create_ata<'info>(
    ...
    let cpi_program = ata_program.clone();
...
pub fn transfer_sol_with_seeds<'info>(
    ...
    .map_err(|_| error!(RaffleError::SolTransferFailed))
}
...
pub fn close_token_account_with_seeds<'info>(
    ...
    .map_err(|_| error!(RaffleErrors::CloseAccountFailed))
}
